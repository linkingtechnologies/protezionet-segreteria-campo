...
// $file
  ...
  $init = 'save_callback:"camila_editarea_save",start_highlight:true,syntax:"xml",language: "' . CAMILA_LANG . '",toolbar:"save,|,search,|,undo,redo,|,select_font,|,change_smooth_selection,highlight,reset_highlight,|,help"';
