<?php
  ...
  class CAMILA_GVA_deck extends CHAW_deck
  {
      var $_gva_out = 'json';
                          ...
                          case 'json':
                              ...
                              if (is_array($column))
                                  ...
                                  switch($column->metatype) {
                                      case 'I':
                                      case 'N':
                                          $cols[] = array('id' => $b, 'label' => $text, 'type' => 'number', 'name' => $column->field);
                                          break;

                                      default:
                                          $cols[] = array('id' => $b, 'label' => $text, 'type' => 'string', 'name' => $column->field);
                                  }
                              }
                              ...
                              $jarr = array_merge($this->custom_properties, array('version'=>$this->_gva_version,'status'=>$this->_gva_status,'table'=>$this->_gva_table,'sig'=>md5(serialize($this->_gva_table))));
