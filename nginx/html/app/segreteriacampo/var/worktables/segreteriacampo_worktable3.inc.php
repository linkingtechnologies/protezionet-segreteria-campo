...
if (camila_form_in_update_mode('segreteriacampo_worktable3')) {

    

    $form = new dbform('segreteriacampo_worktable3', 'id');
...
if (is_object($form->fields['dimensionetesto'])) $form->fields['dimensionetesto']->defaultvalue = worktable_parse_default_expression('22', $form);
    ...
    $form->draw();
	  ...
	  //if ($_CAMILA['adm_user_group'] == CAMILA_ADM_USER_GROUP)
	//	  $stmt = 'select ' . $admin_report_fields . ' from segreteriacampo_worktable3';
	  //else
		  $stmt = 'select ' . $report_fields . ' from segreteriacampo_worktable3';
