...
if (camila_form_in_update_mode(segreteriacampo_worktable28)) {

    

    $form = new dbform('segreteriacampo_worktable28', 'id');
    ...
    new form_integer($form, 'numeroreport', 'NUMERO REPORT', false, 5, 255, '');
if (is_object($form->fields['numeroreport'])) $form->fields['numeroreport']->defaultvalue = worktable_get_next_autoincrement_value('segreteriacampo_worktable28','numeroreport');

    
    new form_datetime($form, 'data1', 'DATA', false, '');
if (is_object($form->fields['data1'])) $form->fields['data1']->hslots = 60;
if (is_object($form->fields['data1'])) $form->fields['data1']->defaultvalue = date('Y-m-d H:i:s');

    
    new form_textarea($form, 'sintesiattivitasvolte', 'SINTESI ATTIVITA\' SVOLTE', false, 10, 80, 1000, '');

    
    new form_textarea($form, 'criticitariscontrate', 'CRITICITA\' RISCONTRATE', false, 10, 80, 1000, '');

    
    new form_static_listbox($form, 'diffcoordvolontari', 'DIFF. COORD. VOLONTARI', 'NO,SI', false, '');

    
    new form_static_listbox($form, 'ritardicambiturnomezzo', 'RITARDI CAMBI TURNO/MEZZO', 'NO,SI', false, '');

    
    new form_static_listbox($form, 'difficoltanellecomunicazioni', 'DIFFICOLTA\' NELLE COMUNICAZIONI', 'NO,SI', false, '');
    ...
    $form->draw();
      ...
      $report_fields = 'id,cf_bool_is_special,cf_bool_is_selected,numeroreport,data1,sintesiattivitasvolte,criticitariscontrate,diffcoordvolontari,ritardicambiturnomezzo,difficoltanellecomunicazioni,note,created,created_by,created_by_surname,created_by_name,last_upd,last_upd_by,last_upd_by_surname,last_upd_by_name,mod_num';
	  //$admin_report_fields = '';
      $default_fields = 'cf_bool_is_special,cf_bool_is_selected,numeroreport,data1,sintesiattivitasvolte,criticitariscontrate,diffcoordvolontari,ritardicambiturnomezzo,difficoltanellecomunicazioni,note';
      ...
      if ($_CAMILA['page']->camila_exporting())
          $mapping = 'created=Data creazione#last_upd=Ultimo aggiornamento#last_upd_by=Utente ult. agg.#last_upd_src=Sorgente Ult. agg.#last_upd_by_name=Nome Utente ult. agg.#last_upd_by_surname=Cognome Utente ult. agg.#mod_num=Num. mod.#id=Cod. riga#created_by=Utente creaz.#created_src=Sorgente creaz.#created_by_surname=Cognome Utente creaz.#created_by_name=Nome Utente creaz.#cf_bool_is_special=contrassegnati come speciali#cf_bool_is_selected=selezionati#numeroreport=NUMERO REPORT#data1=DATA#sintesiattivitasvolte=SINTESI ATTIVITA\' SVOLTE#criticitariscontrate=CRITICITA\' RISCONTRATE#diffcoordvolontari=DIFF. COORD. VOLONTARI#ritardicambiturnomezzo=RITARDI CAMBI TURNO/MEZZO#difficoltanellecomunicazioni=DIFFICOLTA\' NELLE COMUNICAZIONI#note=NOTE';
      else
          $mapping = 'created=Data creazione#last_upd=Ultimo aggiornamento#last_upd_by=Utente ult. agg.#last_upd_src=Sorgente Ult. agg.#last_upd_by_name=Nome Utente ult. agg.#last_upd_by_surname=Cognome Utente ult. agg.#mod_num=Num. mod.#id=Cod. riga#created_by=Utente creaz.#created_src=Sorgente creaz.#created_by_surname=Cognome Utente creaz.#created_by_name=Nome Utente creaz.#cf_bool_is_special=contrassegnati come speciali#cf_bool_is_selected=selezionati#numeroreport=NUM. REPORT#data1=DATA#sintesiattivitasvolte=ATTIVITA\' SVOLTE#criticitariscontrate=CRITICITA\'#diffcoordvolontari=DIFF. COORD. VOLONT.#ritardicambiturnomezzo=RIT. CAMBI TURNO/MEZ#difficoltanellecomunicazioni=DIFF. NELLE COMUNIC.#note=NOTE';
	  ...
	  //if ($_CAMILA['adm_user_group'] == CAMILA_ADM_USER_GROUP)
	//	  $stmt = 'select ' . $admin_report_fields . ' from segreteriacampo_worktable28';
	  //else
		  $stmt = 'select ' . $report_fields . ' from segreteriacampo_worktable28';
      
      $report = new report($stmt.$filter, '', 'data1', 'desc', $mapping, null, 'id', $default_fields, '', (isset($_REQUEST['camila_rest'])) ? false : true, (isset($_REQUEST['camila_rest'])) ? false : true);
      ...
      $jarr=Array();
$jarr['url'] = 'diffcoordvolontari';
$jarr['visible'] = 'yes';
$jarr['short_title'] = 'MODIFICA DIFF. COORD. VOLONTARI';
$jarr['parent'] = 'index.php';
$report->menuitems[]=$jarr;
$jarr=Array();
$jarr['url'] = "javascript:camila_inline_update_selected('diffcoordvolontari','NO')";
$jarr['visible'] = 'yes';
$jarr['short_title'] = 'NO';
$jarr['parent'] = 'diffcoordvolontari';
$report->menuitems[]=$jarr;
$jarr=Array();
$jarr['url'] = "javascript:camila_inline_update_selected('diffcoordvolontari','SI')";
$jarr['visible'] = 'yes';
$jarr['short_title'] = 'SI';
$jarr['parent'] = 'diffcoordvolontari';
$report->menuitems[]=$jarr;
$jarr=Array();
$jarr['url'] = 'ritardicambiturnomezzo';
$jarr['visible'] = 'yes';
$jarr['short_title'] = 'MODIFICA RITARDI CAMBI TURNO/MEZZO';
$jarr['parent'] = 'index.php';
$report->menuitems[]=$jarr;
$jarr=Array();
$jarr['url'] = "javascript:camila_inline_update_selected('ritardicambiturnomezzo','NO')";
$jarr['visible'] = 'yes';
$jarr['short_title'] = 'NO';
$jarr['parent'] = 'ritardicambiturnomezzo';
$report->menuitems[]=$jarr;
$jarr=Array();
$jarr['url'] = "javascript:camila_inline_update_selected('ritardicambiturnomezzo','SI')";
$jarr['visible'] = 'yes';
$jarr['short_title'] = 'SI';
$jarr['parent'] = 'ritardicambiturnomezzo';
$report->menuitems[]=$jarr;
$jarr=Array();
$jarr['url'] = 'difficoltanellecomunicazioni';
$jarr['visible'] = 'yes';
$jarr['short_title'] = 'MODIFICA DIFFICOLTA\' NELLE COMUNICAZIONI';
$jarr['parent'] = 'index.php';
$report->menuitems[]=$jarr;
$jarr=Array();
$jarr['url'] = "javascript:camila_inline_update_selected('difficoltanellecomunicazioni','NO')";
$jarr['visible'] = 'yes';
$jarr['short_title'] = 'NO';
$jarr['parent'] = 'difficoltanellecomunicazioni';
$report->menuitems[]=$jarr;
$jarr=Array();
$jarr['url'] = "javascript:camila_inline_update_selected('difficoltanellecomunicazioni','SI')";
$jarr['visible'] = 'yes';
$jarr['short_title'] = 'SI';
$jarr['parent'] = 'difficoltanellecomunicazioni';
$report->menuitems[]=$jarr;
