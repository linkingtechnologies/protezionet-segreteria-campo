...
if (camila_form_in_update_mode('segreteriacampo_worktable10')) {

    

    $form = new dbform('segreteriacampo_worktable10', 'id');
...
{
$form->fields['tenda']->autosuggest_table = 'segreteriacampo_worktable9';
...
{
$form->fields['cognome']->autosuggest_table = 'segreteriacampo_worktable9';
...
{
$form->fields['nome']->autosuggest_table = 'segreteriacampo_worktable9';
...
{
$form->fields['annodinascita']->autosuggest_table = 'segreteriacampo_worktable9';
...
{
$form->fields['codicebadge']->autosuggest_table = 'segreteriacampo_worktable9';
...
{
$form->fields['ospitedal']->autosuggest_table = 'segreteriacampo_worktable9';
...
{
$form->fields['sesso']->autosuggest_table = 'segreteriacampo_worktable9';
...
{
$form->fields['note']->autosuggest_table = 'segreteriacampo_worktable9';
...
$form->fields['note']->autosuggest_destfields = 'tenda,cognome,nome,annodinascita,codicebadge,ospitedal,sesso';
    ...
    $form->draw();
	  ...
	  //if ($_CAMILA['adm_user_group'] == CAMILA_ADM_USER_GROUP)
	//	  $stmt = 'select ' . $admin_report_fields . ' from segreteriacampo_worktable10';
	  //else
		  $stmt = 'select ' . $report_fields . ' from segreteriacampo_worktable10';
      
      $report = new report($stmt.$filter, '', 'ospiteal', 'desc', $mapping, null, 'id', $default_fields, '', (isset($_REQUEST['camila_rest'])) ? false : true, (isset($_REQUEST['camila_rest'])) ? false : true);
