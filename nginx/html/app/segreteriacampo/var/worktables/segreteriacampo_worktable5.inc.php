...
if (camila_form_in_update_mode('segreteriacampo_worktable5')) {

    

    $form = new dbform('segreteriacampo_worktable5', 'id');
    ...
    new form_datetime($form, 'data1', 'Data', true, '');
...
if (is_object($form->fields['data1'])) $form->fields['data1']->defaultvalue = date('Y-m-d H:i:s');
    ...
    new form_textbox($form, 'da', 'Da', true, 30, 255, '');

    
    new form_textbox($form, 'a1', 'A', false, 30, 255, '');

    
    new form_static_listbox($form, 'canale', 'Canale', 'Interno,Web,App,Radio', false, '');

    
    new form_textbox($form, 'oggetto', 'Oggetto', false, 30, 255, '');
    ...
    $form->draw();
      ...
      $report_fields = 'id,cf_bool_is_special,cf_bool_is_selected,data1,da,a1,canale,oggetto,testo,created,created_by,created_by_surname,created_by_name,last_upd,last_upd_by,last_upd_by_surname,last_upd_by_name,mod_num';
	  //$admin_report_fields = '';
      $default_fields = 'cf_bool_is_special,cf_bool_is_selected,data1,da,a1,canale,oggetto,testo';
	  ...
	  //if ($_CAMILA['adm_user_group'] == CAMILA_ADM_USER_GROUP)
	//	  $stmt = 'select ' . $admin_report_fields . ' from segreteriacampo_worktable5';
	  //else
		  $stmt = 'select ' . $report_fields . ' from segreteriacampo_worktable5';
...
$jarr['url'] = 'canale';
$jarr['visible'] = 'yes';
$jarr['short_title'] = 'MODIFICA Canale';
$jarr['parent'] = 'index.php';
$report->menuitems[]=$jarr;
$jarr=Array();
$jarr['url'] = "javascript:camila_inline_update_selected('canale','Interno')";
$jarr['visible'] = 'yes';
$jarr['short_title'] = 'Interno';
$jarr['parent'] = 'canale';
$report->menuitems[]=$jarr;
$jarr=Array();
$jarr['url'] = "javascript:camila_inline_update_selected('canale','Web')";
$jarr['visible'] = 'yes';
$jarr['short_title'] = 'Web';
$jarr['parent'] = 'canale';
$report->menuitems[]=$jarr;
$jarr=Array();
$jarr['url'] = "javascript:camila_inline_update_selected('canale','App')";
$jarr['visible'] = 'yes';
$jarr['short_title'] = 'App';
$jarr['parent'] = 'canale';
$report->menuitems[]=$jarr;
$jarr=Array();
$jarr['url'] = "javascript:camila_inline_update_selected('canale','Radio')";
$jarr['visible'] = 'yes';
$jarr['short_title'] = 'Radio';
$jarr['parent'] = 'canale';
$report->menuitems[]=$jarr;
$jarr=Array();
