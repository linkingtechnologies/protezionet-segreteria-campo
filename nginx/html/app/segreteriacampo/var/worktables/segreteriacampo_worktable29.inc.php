...
if (camila_form_in_update_mode('segreteriacampo_worktable29')) {

    

    $form = new dbform('segreteriacampo_worktable29', 'id');
    ...
    new form_datetime($form, 'dataora', 'DATA/ORA', false, '');
if (is_object($form->fields['dataora'])) $form->fields['dataora']->hslots = 60;

    
    new form_textbox($form, 'gruppo', 'GRUPPO', false, 30, 255, '');

    
    new form_textbox($form, 'risorsa', 'RISORSA', false, 30, 255, '');

    
    new form_textbox($form, 'tiporisorsa', 'TIPO RISORSA', false, 30, 255, '');
    ...
    $form->draw();
      ...
      $report_fields = 'id,cf_bool_is_special,cf_bool_is_selected,dataora,gruppo,risorsa,tiporisorsa,da,a1,created,created_by,created_by_surname,created_by_name,last_upd,last_upd_by,last_upd_by_surname,last_upd_by_name,mod_num';
	  //$admin_report_fields = '';
      $default_fields = 'cf_bool_is_special,cf_bool_is_selected,dataora,gruppo,risorsa,tiporisorsa,da,a1';
	  ...
	  //if ($_CAMILA['adm_user_group'] == CAMILA_ADM_USER_GROUP)
	//	  $stmt = 'select ' . $admin_report_fields . ' from segreteriacampo_worktable29';
	  //else
		  $stmt = 'select ' . $report_fields . ' from segreteriacampo_worktable29';
      ...
      $jarr=Array();
$jarr['url'] = "javascript:camila_inline_update_selected('gruppo','')";
$jarr['visible'] = 'yes';
$jarr['short_title'] = 'MODIFICA GRUPPO...';
$jarr['parent'] = 'index.php';
$report->menuitems[]=$jarr;
$jarr=Array();
$jarr['url'] = "javascript:camila_inline_update_selected('risorsa','')";
$jarr['visible'] = 'yes';
$jarr['short_title'] = 'MODIFICA RISORSA...';
$jarr['parent'] = 'index.php';
$report->menuitems[]=$jarr;
$jarr=Array();
$jarr['url'] = "javascript:camila_inline_update_selected('tiporisorsa','')";
$jarr['visible'] = 'yes';
$jarr['short_title'] = 'MODIFICA TIPO RISORSA...';
$jarr['parent'] = 'index.php';
$report->menuitems[]=$jarr;
$jarr=Array();
