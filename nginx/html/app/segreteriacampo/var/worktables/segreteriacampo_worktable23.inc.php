...
if (camila_form_in_update_mode(segreteriacampo_worktable23)) {
    ...
    new form_textbox($form, 'marcaemodello', 'MARCA E MODELLO', false, 30, 255, '');

    
    new form_textbox($form, 'targa', 'TARGA', false, 30, 255, '');

    
    new form_textbox($form, 'x', '4X4', false, 30, 255, '');

    
    new form_textbox($form, 'cassone', 'CASSONE', false, 30, 255, '');

    
    new form_textbox($form, 'postiasedere', 'POSTI A SEDERE', false, 30, 255, '');
    ...
    new form_integer($form, 'numero', 'NUMERO', false, 5, 255, '');
...
$form->fields['organizzazione']->autosuggest_destfields = '';
    ...
    $form->draw();
      ...
      $report_fields = 'id,cf_bool_is_special,cf_bool_is_selected,organizzazione,marcaemodello,targa,x,cassone,postiasedere,turno,provincia,codiceorganizzazione,servizio,numero,note,created,created_by,created_by_surname,created_by_name,last_upd,last_upd_by,last_upd_by_surname,last_upd_by_name,mod_num';
	  //$admin_report_fields = '';
      $default_fields = 'cf_bool_is_special,cf_bool_is_selected,organizzazione,marcaemodello,targa,x,cassone,postiasedere,turno,provincia,codiceorganizzazione,servizio,numero,note';
...
$report->menuitems[]=$jarr;
$jarr=Array();
$jarr['url'] = "javascript:camila_inline_update_selected('x','')";
$jarr['visible'] = 'yes';
$jarr['short_title'] = 'MODIFICA 4X4...';
$jarr['parent'] = 'index.php';
$report->menuitems[]=$jarr;
$jarr=Array();
$jarr['url'] = "javascript:camila_inline_update_selected('cassone','')";
$jarr['visible'] = 'yes';
$jarr['short_title'] = 'MODIFICA CASSONE...';
$jarr['parent'] = 'index.php';
$report->menuitems[]=$jarr;
$jarr=Array();
$jarr['url'] = "javascript:camila_inline_update_selected('postiasedere','')";
$jarr['visible'] = 'yes';
$jarr['short_title'] = 'MODIFICA POSTI A SEDERE...';
$jarr['parent'] = 'index.php';
$report->menuitems[]=$jarr;
$jarr=Array();
