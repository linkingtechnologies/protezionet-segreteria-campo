...
if (camila_form_in_update_mode(segreteriacampo_worktable2)) {

    

    $form = new dbform('segreteriacampo_worktable2', 'id');
...
if (is_object($form->fields['data1'])) $form->fields['data1']->defaultvalue = date('Y-m-d');
    ...
    new form_textbox($form, 'richiedente', 'Richiedente', true, 30, 100, 'uppercase');

    
    new form_textbox($form, 'richiesta', 'Richiesta', true, 30, 240, '');

    
    new form_static_listbox($form, 'tiporichiesta', 'Tipo Richiesta', 'Interna,Esterna', true, '');
if (is_object($form->fields['tiporichiesta'])) $form->fields['tiporichiesta']->defaultvalue = worktable_parse_default_expression('Esterna', $form);

    
    new form_static_listbox($form, 'priorit', 'Priorità', '1 - Urgente,2 - Alta,3 - Normale,4 - Bassa,5 - Molto bassa', true, '');
if (is_object($form->fields['priorit'])) $form->fields['priorit']->defaultvalue = worktable_parse_default_expression('3 - Normale', $form);

    
    new form_textbox($form, 'assegnatariorichiesta', 'Assegnatario richiesta', false, 30, 100, '');

    
    new form_static_listbox($form, 'stato', 'Stato', 'A - Presa in carico,B - In valutazione,C1 - In lavorazione,C2 - In attesa di lavorazione,D1 - Eseguita,D2 - Respinta', true, '');
if (is_object($form->fields['stato'])) $form->fields['stato']->defaultvalue = worktable_parse_default_expression('A - Presa in carico', $form);
    ...
    if (is_object($form->fields['assegnatariorichiesta']))
{
$form->fields['assegnatariorichiesta']->autosuggest_table = 'segreteriacampo_worktable18';
$form->fields['assegnatariorichiesta']->autosuggest_field = 'cognome';
$form->fields['assegnatariorichiesta']->autosuggest_idfield = 'id';
$form->fields['assegnatariorichiesta']->autosuggest_infofields = '';
$form->fields['assegnatariorichiesta']->autosuggest_pickfields = '';
$form->fields['assegnatariorichiesta']->autosuggest_destfields = '';
}
    ...
    $form->draw();
      ...
      $report_fields = 'id,cf_bool_is_special,cf_bool_is_selected,data1,richiedente,richiesta,tiporichiesta,priorit,assegnatariorichiesta,stato,note,created,created_by,created_by_surname,created_by_name,last_upd,last_upd_by,last_upd_by_surname,last_upd_by_name,mod_num';
	  //$admin_report_fields = '';
      $default_fields = 'cf_bool_is_special,cf_bool_is_selected,data1,richiedente,richiesta,tiporichiesta,priorit,assegnatariorichiesta,stato,note';
	  ...
	  //if ($_CAMILA['adm_user_group'] == CAMILA_ADM_USER_GROUP)
	//	  $stmt = 'select ' . $admin_report_fields . ' from segreteriacampo_worktable2';
	  //else
		  $stmt = 'select ' . $report_fields . ' from segreteriacampo_worktable2';
...
$jarr=Array();
$jarr['url'] = "javascript:camila_inline_update_selected('richiedente','')";
$jarr['visible'] = 'yes';
$jarr['short_title'] = 'MODIFICA Richiedente...';
$jarr['parent'] = 'index.php';
$report->menuitems[]=$jarr;
$jarr=Array();
$jarr['url'] = "javascript:camila_inline_update_selected('richiesta','')";
$jarr['visible'] = 'yes';
$jarr['short_title'] = 'MODIFICA Richiesta...';
$jarr['parent'] = 'index.php';
$report->menuitems[]=$jarr;
$jarr=Array();
$jarr['url'] = 'tiporichiesta';
$jarr['visible'] = 'yes';
$jarr['short_title'] = 'MODIFICA Tipo Richiesta';
$jarr['parent'] = 'index.php';
$report->menuitems[]=$jarr;
$jarr=Array();
$jarr['url'] = "javascript:camila_inline_update_selected('tiporichiesta','Interna')";
$jarr['visible'] = 'yes';
$jarr['short_title'] = 'Interna';
$jarr['parent'] = 'tiporichiesta';
$report->menuitems[]=$jarr;
$jarr=Array();
$jarr['url'] = "javascript:camila_inline_update_selected('tiporichiesta','Esterna')";
$jarr['visible'] = 'yes';
$jarr['short_title'] = 'Esterna';
$jarr['parent'] = 'tiporichiesta';
$report->menuitems[]=$jarr;
$jarr=Array();
$jarr['url'] = 'priorit';
...
$report->menuitems[]=$jarr;
$jarr=Array();
$jarr['url'] = "javascript:camila_inline_update_selected('priorit','1 - Urgente')";
$jarr['visible'] = 'yes';
$jarr['short_title'] = '1 - Urgente';
$jarr['parent'] = 'priorit';
$report->menuitems[]=$jarr;
$jarr=Array();
$jarr['url'] = "javascript:camila_inline_update_selected('priorit','2 - Alta')";
$jarr['visible'] = 'yes';
$jarr['short_title'] = '2 - Alta';
$jarr['parent'] = 'priorit';
$report->menuitems[]=$jarr;
$jarr=Array();
$jarr['url'] = "javascript:camila_inline_update_selected('priorit','3 - Normale')";
$jarr['visible'] = 'yes';
$jarr['short_title'] = '3 - Normale';
$jarr['parent'] = 'priorit';
$report->menuitems[]=$jarr;
$jarr=Array();
$jarr['url'] = "javascript:camila_inline_update_selected('priorit','4 - Bassa')";
$jarr['visible'] = 'yes';
$jarr['short_title'] = '4 - Bassa';
$jarr['parent'] = 'priorit';
$report->menuitems[]=$jarr;
$jarr=Array();
$jarr['url'] = "javascript:camila_inline_update_selected('priorit','5 - Molto bassa')";
$jarr['visible'] = 'yes';
$jarr['short_title'] = '5 - Molto bassa';
$jarr['parent'] = 'priorit';
$report->menuitems[]=$jarr;
$jarr=Array();
$jarr['url'] = "javascript:camila_inline_update_selected('assegnatariorichiesta','')";
$jarr['visible'] = 'yes';
$jarr['short_title'] = 'MODIFICA Assegnatario richiesta...';
$jarr['parent'] = 'index.php';
$report->menuitems[]=$jarr;
$jarr=Array();
$jarr['url'] = 'stato';
$jarr['visible'] = 'yes';
$jarr['short_title'] = 'MODIFICA Stato';
$jarr['parent'] = 'index.php';
$report->menuitems[]=$jarr;
$jarr=Array();
$jarr['url'] = "javascript:camila_inline_update_selected('stato','A - Presa in carico')";
$jarr['visible'] = 'yes';
$jarr['short_title'] = 'A - Presa in carico';
$jarr['parent'] = 'stato';
$report->menuitems[]=$jarr;
$jarr=Array();
$jarr['url'] = "javascript:camila_inline_update_selected('stato','B - In valutazione')";
$jarr['visible'] = 'yes';
